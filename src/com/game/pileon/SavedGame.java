 ...
 * @author breeze4
 * 
 * Object that gets serialized, contains save game data and methods for adding and getting pieces of saved game
 *
 */
...
public class SavedGame
{
	...
	public String toString()
	{
		...
		savedGameString += 
				"Piles: " + savePiles.toString() + 
				" Hands: " + saveHands.toString() + 
				" Deck: " + saveDeck.toString() + 
