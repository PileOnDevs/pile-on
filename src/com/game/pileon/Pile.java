 ...
 * Pile class
 * 
 * Wrapper class for a Stack that adds some additional game-specific
 * functionality and coordination with PileView
 * 
 * @author breeze4
 * @since 2012-12-30
 */
...
public class Pile {
     ...
     * stack
     * 
     * @return the object at the top of the stack (the last item of the Vector
     *         object)
     */
    public Card peek() {
        return mPile.peek();
    ...
    /**
     * Determines whether or not the card can be played to the pile based on
     * color or value
     * 
     * @return true if the move is legal (either the colors match or the values
     *         match)
     */
